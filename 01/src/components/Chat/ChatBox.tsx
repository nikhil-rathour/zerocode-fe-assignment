...
export const ChatBox = () => {
  ...
  // Voice input handler (stub implementation)
  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-4 h-screen max-h-screen flex flex-col">
      {/* Header */}
      <div className="mb-4 text-center">
        <h1 className="text-2xl md:text-3xl font-bold text-white mb-1">AI Chat Assistant</h1>
